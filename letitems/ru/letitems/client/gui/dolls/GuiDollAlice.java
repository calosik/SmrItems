...
public final class GuiDollAlice extends GuiDollBase {
   ...
   public GuiDollAlice(EntityPlayer player, BlockPos blockPos) {
   ...
   public void drawScreen(int x, int y, float f) {
      ...
      if (openPageRelic != -1) {
         ...
         if (stackHover != -1) {
            ...
            this.drawHoveringText(GuiDollAlice.listText, x + 4, y + 4);
   ...
   static {
      listText.add("§6Кукла Алиса Кисараги");
