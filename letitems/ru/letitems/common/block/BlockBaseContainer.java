...
import ru.letitems.common.util.registry.IHasTileEntity;
...
public abstract class BlockBaseContainer<T extends TileBase> extends BlockContainer implements IHasName, IHasTileEntity<T> {
   ...
   private ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int meta, int fortune, boolean onBreak) {
      TileEntity tile = world.getTileEntity(x, y, z);
