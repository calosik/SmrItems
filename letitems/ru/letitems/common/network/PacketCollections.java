...
public final class PacketCollections extends AbstractPacket {
   private int id;
   private static LockPlayer lockPlayer = new LockPlayer();

   public PacketCollections() {
   }

   public PacketCollections(int id) {
      this.id = id;
   }
   ...
   // $FF: synthetic method
   private void lambda$processServer$0(String name, EntityPlayerMP player, UUID uuid) {
   }
