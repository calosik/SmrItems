...
public class DakimakuraCase extends Item {
    public DakimakuraCase(String name, String texture, int maxStackSize) {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean advancedTooltip) {
        list.add(EnumChatFormatting.DARK_PURPLE + "Содержит редкие предметы из Dakimakura Mod");
    }
}