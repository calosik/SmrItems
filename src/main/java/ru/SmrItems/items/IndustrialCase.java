...
public class IndustrialCase extends Item {
    public IndustrialCase(String name, String texture, int maxStackSize) {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean advancedTooltip) {
        list.add(EnumChatFormatting.DARK_PURPLE + "Содержит редкие предметы из Industrial Craft2");
    }
}
